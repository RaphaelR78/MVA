...
print("Accuracy using Deepwalk embeddings: {:.2f}%".format(100*accuracy_score(y_pred,y_test)))
...
# We use the random walk normalized Laplacian
...
clf.fit(X_train,y_train)
y_pred = clf.predict(X_test)
print("Accuracy using Spectral clustering: {:.2f}%".format(100*accuracy_score(y_pred,y_test)))
